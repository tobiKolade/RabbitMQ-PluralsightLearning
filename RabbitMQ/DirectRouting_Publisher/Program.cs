...
namespace DirectRouting_Publisher
{
    class Program
    {
        ...
        private const string PurchanseOrderQueueName = "PurchaseOrderDirectRouting_Queue";
        ...
        private static void SendPurchaseOrder(PurchaseOrder purchaseOrder)
        {
            ...
            Console.WriteLine($"Purchase Order Sent {purchaseOrder.CompanyName}, ${purchaseOrder.AmountToPay}, {purchaseOrder.PaymentDayTerms}, {purchaseOrder.PoNumber}");
        }
        ...
        private static void CreateConnection()
        {
            ...
            _model.QueueDeclare(PurchanseOrderQueueName, true, false, false, null);

            _model.QueueBind(CardPaymentQueueName, ExchangeName, "CardPayment");
            _model.QueueBind(PurchanseOrderQueueName, ExchangeName, "PurchaseOrder");
        }
